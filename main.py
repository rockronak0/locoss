...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="𝙏𝙧𝙞𝙫𝙞𝙖 𝔾𝕒𝕞𝕚𝕟𝕘 𝐵𝑜𝑠𝑠", description="**Dark Web Searching** :spy:")
        ...
        self.embed.set_footer(text=f"Made With❤By 𝙏𝙧𝙞𝙫𝙞𝙖 𝔾𝕒𝕞𝕚𝕟𝕘 𝐵𝑜𝑠𝑠", \
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=1,name='TRIVIA GAMING BOSS||*help'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('Njc2MjY1MzM1NzMyODMwMjE4.XkDSMw.FI51CefX5QTkZFBX17uv6H6c1Pg'))
    loop.run_forever()
