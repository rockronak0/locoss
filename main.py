...
class SelfBot(discord.Client):
    ...
    async def on_ready(self):
        print("======================")
        print("💥HACK TRIVIA PRO💥 to discord.")
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="💥HACK TRIVIA PRO💥 ANSWER BOT")
        ...
        self.embed.set_footer(text='Ⱨ₳₵₭ɆⱤ▄︻̷̿┻̿═━|🎭|#6898')
    ...
    async def update_embeds(self):
      #  global wrong
        ...
        self.embed.set_footer(text='꧁༒۝ŘĮŤĘ§H۝༒꧂& Rakshit')
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjQ4OTE2ODQzNTcwMDA0MDEw.Xd1M7w.3IwtHdXxkPY1EbvTKvuHOhQIVeo'))
    loop.run_forever()
