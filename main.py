...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="LOCO TRIVIA", description="**Google Searching** ••••:spy:")
        ...
        self.embed.set_footer(text=f"꧁༒۝ŘĮŤĘ§H۝༒꧂",
...
#                 three_check = ":x:"            
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='LOCO TRIVIA || ?help'))
