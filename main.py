...
#BOT_OWNER_ROLE_ID = "611048756951121920"
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="💥HACK TRIVIA PRO💥", description="**Google Searching** ••••••••••••:spy:")
        ...
        self.embed.set_footer(text=f"꧁༒۝ŘĮŤĘ§H۝༒꧂& MAHI",
            icon_url="https://cdn.discordapp.com/attachments/643846034920964139/644058846180016128/20191112_190147.jpg")
...
#                 three_check = ":x:"            
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='꧁༒۝ŘĮŤĘ§H۝༒꧂|| ?help'))
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith('?help'):
          if BOT_OWNER_ROLE in [role.name for role in message.author.roles]:
           ...
           embed.add_field(name="Support Game", value="**Loco\Flipkard\Hq trivia**", inline=False)
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjQ3NTIzMzg5NTg5OTQ2NDE5.Xdg7WQ.BIawYKaJi1PHHIwCtVATd0bjYkQ'))
    loop.run_forever()
